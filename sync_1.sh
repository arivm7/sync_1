...
##
##  ============================================================================
##  [CONFIG START] Начало секции, перекрываемой из конфиг-файла
##
...
##
##  [CONFIG END] Конец секции, перекрываемой из конфиг-файла
##  ----------------------------------------------------------------------------
##
...
Использование:
    ...
    ${SYNC_CMD_CLOUD_UP_INIT} <user@host:/путь/облачная_папка>
...
Разумеется, классика:
    ...
    --edit-conf | -e    Редактирование конфига ${CONFIG_FILE}"
...
Использование: ${APP_NAME} [папка | число_строк | cloud_path] [команда]
  ...
  [команда]       — одна из: [ ${str1} ]
                             ...
                             По умолчанию: ${SYNC_CMD_REGULAR}
  --usage     | -u  — Показать краткое использование
  --help      | -h  — Показать полную справку
  --version   | -v  — Показать версию
  --edit-conf | -e  — Редактирование конфига
EOF
}
